	     		...
	     		<div class="modal-body">
	       			<div class="form-group">
					    ...
					    <div class="input-group mb-3">
  						...
  						<input type="text" class="form-control" placeholder="usuario" aria-label="Username" aria-describedby="basic-addon1" required="" name="name">
						</div>
					  </div>
					  <div class="form-group">
					    ...
					    <div class="input-group mb-3">
  						...
  						<input type="text" class="form-control" placeholder="usuario@hotmail.com" aria-label="correo" aria-describedby="basic-addon1" required="" name="email">
						</div>
					  </div>
					  <div class="form-group">
